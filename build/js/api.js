...
$(document).ready(function () {
    ...
    $(".hero-search-form-wrapper form").on("submit", function (e) {
        ...
        window.open("search.html?query="+searchText+"&location="+location+"&page=1","_self");
    ...
    $(".prartices-wrapper .btn-primary").on("click", function (e) {
        ...
        if($(".practices-search option:selected").attr("data-pr-or-sp")==="pr") {
            var practiceArea = $(".practices-search").val();
            var speciality = "";
        }
        else{
        ...
        window.open("search.html?practiceArea="+practiceArea+"&speciality="+speciality+"&location="+location+"&page=1","_self");
        $("body").removeClass("loading");
    });
            ...
            success: function (res) {
                ...
                $.each(res, function (key, arr) {
                    if(res[key]['address']!==null){
                        var address = res[key]['address']['fullAddress'];
                    }
                    else{
                        address = "";
                    }
                    ...
                    var id = res[key]['id'];
                    item += '                    <div class="register-results__people-item">\n' +
                        ...
                        '                            </div>\n' +
                        '                        </div>\n' +
                        '                        <button class="btn btn-primary claim-btn" data-id="'+id+'">Claim profile</button>\n' +
                        '                    </div>\n';
                });
                ...
                if(count <= 9){
                    ...
                    for(i=1; i<=$cycleSize; i++){
                        ...
                        if(decade >= 6){
                            if(i<=6){
                                links += '<a class="need-captcha-reg '+active+'">' + i + '</a>';
                            }
                            else{
                                if(i===decade){
                ...
                $(".step1").after('<section class="register step2" style="display:none;">\n' +
                    '    <div class="container">\n' +
                    ...
                    '                <p class="search-name">Lawyers named <span>'+name+'</span></p>\n' +
                    '                <p class="count-results">'+count+' found</p>\n' +
                    '                <div class="register-results__people">\n' + item +
                    '                </div>' +
                    '<div class="captcha">' +
                    '   <div class="g-recaptcha" id="RecaptchaField3" data-sitekey="6Lf58MMUAAAAADTt9hFqPtejb4nK8fxUgtLtRDoM"></div>\n' +
                    ...
                    '    </div>\n' +
                    '</section>');
                grecaptcha.render('RecaptchaField3', {'sitekey' : '6Lf58MMUAAAAADTt9hFqPtejb4nK8fxUgtLtRDoM'});
                $(".step1").fadeOut();
                $(".step2").fadeIn();
            },
            complete: function () {
    ...
    *
        ...
        $.ajax({
            ...
            success: function (res) {
                ...
                if(res['address']['address1']){
                    address = '<p><span class="icon-location-g"></span>'+address+'</p>';
                }
                if(education !== ""){
                    education = '<p><span class="icon-education"></span>'+education+'</p>';
                }
                var license = [];
                $.each(res['licenses'], function (pkey, parr) {
                    ...
                    if(res['licenses'][pkey]['date']) {
                        ...
                        license.push('<div class="license">' +
                            '<span class="year">Licensed for ' + diffYear + ' years</span>' +
                            '<span class="number">' + res['licenses'][pkey]['state'] + ' - '+licenseDate+'</span>' +
                            '</div>');
                    }
                    else{
                        license = "";
                ...
                if(license)
                    license.join("");
                $(".step2, .single-page-profile").after('<section class="register step3" style="display:none;">\n' +
                    '    <div class="container">\n' +
                    '        <div class="register-wrapper">\n' +
                    '            <a href="#" class="previous-step"><span class="icon-arrow-down"></span>Previous Step</a>\n' +
                    ...
                    '                <label for="styled-checkbox-1">I confirm that I am '+name+' and I accept DiversePro\'s <a href="terms.html" target="_blank">Terms of Use</a> and <a href="privacy.html" target="_blank">Privacy Policy</a>.\n' +
                    '                </label>\n' +
                    '            </div>\n' +
                    '            <button class="btn btn-primary from-step3" data-id="'+id+'">Continue</button>\n' +
                    '        </div>\n' +
                    '    </div>\n' +
                    '</section>');
    ...
    $(document).on('click', '.create-account', function () {
        $(".step2").fadeOut();
        $(".step2").after('<section class="register step3-create" style="display:none;">\n' +
            '    <div class="container">\n' +
            '        <div class="register-wrapper">\n' +
            '            <a href="#" class="previous-step"><span class="icon-arrow-down"></span>Previous Step</a>\n' +
    ...
    $(document).on('click', '.from-step3-create', function () {
        if($("#styled-checkbox-5").is(':checked')) {
            $(".step4").remove();
            $(".step3-create").after('<section class="register step4" style="display:none;">\n' +
                '    <div class="container">\n' +
                '        <div class="register-wrapper">\n' +
                '            <a href="#" class="previous-step"><span class="icon-arrow-down"></span>Previous Step</a>\n' +
            ...
            $("#styled-checkbox-5").next().after('<p class="need-check">To claim or create your profile, you must agree to DiversePro’s <a href="terms.html" target="_blank">Terms of Use</a> and <a href="privacy.html" target="_blank">Privacy Policy</a>.</p>')
        }
    });
        ...
        if($("#styled-checkbox-1").is(':checked')) {
            ...
            $.ajax({
                ...
                success: function (res) {
                    ...
                    $(".step4").remove();
                    $(".step3").after('<section class="register step4 claim-account" style="display:none;">\n' +
                        '    <div class="container">\n' +
                        '        <div class="register-wrapper">\n' +
                        '            <a href="#" class="previous-step"><span class="icon-arrow-down"></span>Previous Step</a>\n' +
                        '            <h2>Add your contact information</h2>\n' +
                        ...
                        '                    <div class="form-group">\n' +
                        '                        <label for="firstname">First Name <span class="required">*</span></label>\n' +
                        '                        <input type="text" id="firstname" placeholder="Type here" value="'+firstName+'" required>\n' +
                        '                    </div>\n' +
                        '                    <div class="form-group">\n' +
                        '                        <label for="middlename">Middle Name</label>\n' +
                        '                        <input type="text" id="middlename" placeholder="Type here" value="'+middleName+'">\n' +
                        '                    </div>\n' +
                        '                    <div class="form-group">\n' +
                        '                        <label for="maidenname">Maiden Name</label>\n' +
                        '                        <input type="text" id="maidenname" placeholder="Type here" value="'+maidenName+'">\n' +
                        '                    </div>\n' +
                        '                    <div class="form-group">\n' +
                        '                        <label for="lastname">Last Name <span class="required">*</span></label>\n' +
                        '                        <input type="text" id="lastname" placeholder="Type here" value="'+lastName+'" required>\n' +
                        '                    </div>\n' +
                        '                    <h3>Business details</h3>\n' +
                        '                    <b></b>\n' +
                        '                    <div class="form-group">\n' +
                        '                        <label for="company">Company / Organization</label>\n' +
                        '                        <input type="text" id="company" placeholder="Type here" value="'+company+'">\n' +
                        '                    </div>\n' +
                        '                    <div class="form-group">\n' +
                        '                        <label for="address">Address</label>\n' +
                        '                        <input type="text" id="address" placeholder="Type here" value="'+address+'">\n' +
                        '                    </div>\n' +
                        '                    <div class="form-group">\n' +
                        '                        <label for="suite">Suite</label>\n' +
                        '                        <input type="text" id="suite" placeholder="Type here">\n' +
                        ...
                        '                    <div class="form-group">\n' +
                        '                        <label for="city">City</label>\n' +
                        '                        <input type="text" id="city" placeholder="Type here" value="'+city+'">\n' +
                        '                    </div>\n' +
                        '                    <b></b>\n' +
                        '                    <div class="form-group small">\n' +
                        '                        <label for="state">State</label>\n' +
                        ...
                        '                    <div class="form-group small">\n' +
                        '                        <label for="zip">Zip</label>\n' +
                        '                        <input type="text" id="zip" placeholder="Type here" value="'+zips+'">\n' +
                        '                    </div>\n' +
                        '                    <h3>Contacts</h3>\n' +
                        '                    <div class="form-group">\n' +
                        '                        <label for="workphone">Work Phone <span class="required">*</span></label>\n' +
                        '                        <input type="text" id="workphone" class="phone-format" placeholder="Type here" value="'+workPhone+'" required>\n' +
                        '                    </div>\n' +
                        '                    <div class="form-group">\n' +
                        '                        <label for="homephone">Home Phone</label>\n' +
                        '                        <input type="text" id="homephone" class="phone-format" placeholder="Type here" value="'+homePhone+'">\n' +
                        '                    </div>\n' +
                        '                    <div class="form-group">\n' +
                        '                        <label for="mobilephone">Mobile Phone <span class="required">*</span></label>\n' +
                        '                        <input type="text" id="mobilephone" class="phone-format" placeholder="Type here" value="'+mobilePhone+'" required>\n' +
                        '                    </div>\n' +
                        '                    <div class="form-group">\n' +
                        '                        <label for="fax">Fax </label>\n' +
                        '                        <input type="text" id="fax" class="phone-format" placeholder="Type here">\n' +
                        ...
                        '                    <div class="form-group">\n' +
                        '                        <label for="email">Email <span class="required">*</span></label>\n' +
                        '                        <input type="text" id="email" placeholder="Type here" value="'+email+'" required>\n' +
                        '                    </div>\n' +
                        '                    <div class="form-submit">\n' +
                        '                        <p class="description"><span class="required">*</span> Required Fields</p>\n' +
                        '                        <button type="submit" class="btn btn-primary" data-id="'+attorneyId+'">Continue</button>\n' +
                        '                    </div>\n' +
                        '                </form>\n' +
                        '            </div>\n' +
                        '        </div>\n' +
            ...
            $("#styled-checkbox-1").next().after('<p class="need-check">To claim or create your profile, you must agree to DiversePro’s <a href="terms.html" target="_blank">Terms of Use</a> and <a href="privacy.html" target="_blank">Privacy Policy</a>.</p>')
        }
    });
    ...
    $(document).on('submit', '#confirm-phone form', function (e) {
        ...
        $.ajax({
            type: "GET",
            url: apiDomain+'/SendPhoneCode?EmailAddress='+email+'&PhoneNumber='+workPhone,
            success: function () {
                $("#confirm-phone").attr('hidden', true);
                $("#confirm-phone-code").attr('hidden', false);
                $("#confirm-phone-code .confirm .phone-number").text(workPhone);
                $("#confirm-phone-code .confirm .phone-number").attr('data-email', email);
                $("#email").val(email)
            }
        });
    });
    ...
    $(document).on('submit', '#confirm-phone-code form', function (e) {
        e.preventDefault();
        var email = $("#confirm-phone-code .confirm .phone-number").attr('data-email');
        var code = $("#confirmCode").val();
        var phone = $("#confirm-phone-code .confirm .phone-number").text();
        $.ajax({
            type: "POST",
            url: apiDomain+'/ConfirmPhone?Email='+email+'&Code='+code+'&Phone='+phone,
            headers: {
                'Accept': 'application/json',
                'Content-Type': 'application/json'
            },
    ...
    *
    ...
    $(document).on('submit', '#was-verified .was-verified', function (e) {
        ...
        $(".step4").after('<section class="register step5" style="display:none;">\n' +
            '    <div class="container">\n' +
            '        <div class="register-wrapper">\n' +
            '            <a href="#" class="previous-step"><span class="icon-arrow-down"></span>Previous Step</a>\n' +
            ...
            '                    </div>\n' +
            '                    <div class="form-group">\n' +
            '                        <label for="college">College <span class="desc">(optional)</span></label>\n' +
            '                        <select id="college" class="add-info-select">\n' +
            '                            <option></option>\n' +
            '                        </select>\n' +
            '                    </div>\n' +
            '                    <div class="form-group">\n' +
        ...
        if($("#styled-checkbox-4").is(':checked')) {
            ...
            $.ajax({
                ...
                success: function () {
                    ...
                    $(".step5").fadeOut();
                    $(".step5").after('<section class="register step6" style="display:none;">' +
                        '<div class="container">' +
                        '<div class="register-wrapper">' +
                        '<a href="#" class="previous-step"><span class="icon-arrow-down"></span>Previous Step</a>' +
                        ...
                        '<option selected>Diverse</option>' +
                        ...
                        '<div class="tooltip-info">' +
                        ' <img src="images/info.svg" alt="">' +
                        '<p>Eligible lawyers are women, minority, or disabled lawyers and veterans or active duty service members. Visit <a href="terms.html" target="_blank">Terms of Use</a> for more details.</p>' +
                        '</div>' +
                        ' </label>' +
            ...
            $("#styled-checkbox-4").next().after('<p class="need-check">You must confirm that you are in good standing and eligible to practice law in the jurisdiction(s) selected above.</p>')
        }
    });
    ...
    $(document).on('click', '.from-step6', function (e) {
        ...
        if($("#styled-checkbox-3").is(':checked') && $("#categories option:selected").length !== 0) {
            ...
            $.ajax({
                ...
                success: function () {
                    $(".step6").fadeOut();
                    $(".step6").after('<section class="register step7" style="display:none;">\n' +
                        '    <div class="container">\n' +
                        '        <div class="register-wrapper">\n' +
                        '            <a href="#" class="previous-step"><span class="icon-arrow-down"></span>Previous Step</a>\n' +
                        ...
                        '                            <li>Upload videos and photos</li>\n' +
                    ...
                    success: function () {
                        ...
                        if(plan === 'premium'){
                            if($(".step8-premium").length === 0) {
                                $(".step7").after('<section class="register step8-premium" style="display:none;">\n' +
                                    '    <div class="container">\n' +
                                    '        <div class="register-wrapper">\n' +
                                    '            <a href="#" class="previous-step"><span class="icon-arrow-down"></span>Previous Step</a>\n' +
                                    ...
                                    '                    <input id="facebook" placeholder="Link to your profile" autocomplete="offa">\n' +
                                    '                </div>\n' +
                                    '                <div class="form-group">\n' +
                                    '                    <label for="linkedIn">LinkedIn</label>\n' +
                                    '                    <input id="linkedIn" placeholder="Link to your profile" autocomplete="offa">\n' +
                                    '                </div>\n' +
                                    '                <div class="form-group">\n' +
                                    '                    <label for="instagram">Instagram</label>\n' +
                                    '                    <input id="instagram" placeholder="Link to your profile" autocomplete="offa">\n' +
                                    '                </div>\n' +
                                    '                <div class="form-group">\n' +
                                    '                    <label for="twitter">Twitter</label>\n' +
                                    '                    <input id="twitter" placeholder="Link to your profile" autocomplete="offa">\n' +
                                    '                </div>\n' +
                            ...
                            var dropzone_default = new Dropzone("#premium-dropzone", {
                                url: '/',
                                maxFiles: 5
                            });
                        }
                            ...
                            if($(".step8").length === 0) {
                                $(".step7").after('<section class="register step8" style="display:none;">\n' +
                                    '    <div class="container">\n' +
                                    '        <div class="register-wrapper">\n' +
                                    '            <a href="#" class="previous-step"><span class="icon-arrow-down"></span>Previous Step</a>\n' +
                            ...
                            if($(".step8-pro").length === 0) {
                                $(".step7").after('<section class="register step8-pro" style="display:none;">\n' +
                                    '    <div class="container">\n' +
                                    '        <div class="register-wrapper">\n' +
                                    '            <a href="#" class="previous-step"><span class="icon-arrow-down"></span>Previous Step</a>\n' +
    ...
    $(document).on('click', '.btn-preview', function(e) {
        ...
        if ($(".keywords-selected").length && $(".keywords-selected").val().length){
            var keywords =  '<div class="info-block">\n' +
                '                 <h3>Keywords <span class="dotted"></span></h3>\n' +
                '                 <p class="description">' +$(".keywords-selected").val().join(" ")+ '</p>\n' +
                '            </div>';
        }
        else{
            keywords = "";
        ...
        if($("#facebook").length && $("#facebook").val().length) {
            socials.push('<a href="' + $("#facebook").val() + '"><span class="icon-fb"></span></a>');
        }
        if($("#linkedin").length && $("#linkedin").val().length) {
            socials.push('<a href="'+ $("#linkedin").val()+'"><span class="icon-linkedin"></span></a>');
        }
        if($("#instagram").length && $("#instagram").val().length) {
            socials.push('<a href="'+ $("#instagram").val()+'"><span class="icon-inst"></span></a>');
        }
        if($("#twitter").length && $("#twitter").val().length) {
            socials.push('<a href="'+ $("#twitter").val()+'"><span class="icon-twitter"></span></a>');
        }
        socials = socials.join("");
        if(socials.length >0){
            socials = ' <div class="info-block">\n' +
        ...
        if($("#headline").length) {
            if ($("#headline").val().length > 0) {
                var headline = ' <div class="review"><p>' + $("#headline").val() + '</p></div>'
            }
            else{
                headline = "";
            }
        ...
        if($("#about").val().length){
            var about = '<h3>About <span class="dotted"></span></h3><p class="description">' + $("#about").val() + '</p>';
        }
        else{
            about = "";
        }
            ...
            $uploadCrop.croppie('result', {
                ...
                $.ajax({
                    ...
                    success: function (res) {
                        ...
                        if(res['address']) {
                            var address = res['address']['address1'] + ' ' + res['address']['address2'] + '<br> ' + res['address']['city'] + ' ' + res['address']['state'] + ' ' + res['address']['zip'];
                        }
                        else{
                            address = "";
                        }
                        ...
                        $.each(res['professionalInfo']['practiceAreas'], function (pkey, parr) {
                            tags.push('<span>' + res['professionalInfo']['practiceAreas'][pkey] + '</span>');
                        });
                        tags = tags.join("");

                        if (res['biographicalInfo']['languages']) {
                            $.each(res['biographicalInfo']['languages'], function (pkey, parr) {
                                languages.push('<span>' + res['biographicalInfo']['languages'][pkey] + '</span>');
                            });
                            languages = languages.join("");
                        }
                        if(languages.length > 0){
                            languages = '<div class="info-block">\n' +
                        ...
                        if (res['biographicalInfo']['ethnicities']) {
                            $.each(res['biographicalInfo']['ethnicities'], function (pkey, parr) {
                                ethnicities.push('<span>' + res['biographicalInfo']['ethnicities'][pkey] + '</span>');
                            });
                        ...
                        if (res['contactInfo']['workPhoneNumber']) {
                            var phone = '<div class="contact-row">\n' +
                                '             <span class="icon-phone"></span>\n' +
                                '             <p>' + res['contactInfo']['workPhoneNumber'] + '</p>\n' +
                                '        </div>';
                        } else {
                            phone = "";
                        }
                        ...
                        $.each(res['licenses'], function (pkey, parr) {
                            if(res['licenses'][pkey]['date']){
                                ...
                                license.push('<span >' + res['licenses'][pkey]['state'] + ', '+licenseDate+'</span>');
                            }

                        });
                        license.join("");
                        if(license.length > 0){
                            license = '<div class="info-block">\n' +
                        ...
                        if (res['contactInfo']['faxNumber']) {
                            var fax = '<div class="contact-row">\n' +
                                '           <span class="icon-fax-g"></span>\n' +
                                '           <p>' + res['contactInfo']['faxNumber'] + '</p>\n' +
                                '      </div>\n';
                        } else {
                            fax = "";
                        }
                        ...
                        if (plan === 'pro-plus') {
                            ...
                            smoothScroll();
                            $(".step8-pro").fadeOut().after('<section class="profile pro" style="display:none;">\n' +
                                '    <div class="container">\n' +
                                '        <div class="profile-inner">\n' +
                                '            <a href="#" class="return-back"><span class="icon-arrow_left"></span>Back</a>\n' +
                                '            <div class="profile-wrapper">\n' +
                            ...
                            smoothScroll();
                            $(".step8-premium").fadeOut().after('<section class="profile premium" style="display: none">\n' +
                                '    <div class="container">\n' +
                                '        <div class="profile-inner">\n' +
                                '            <a href="#" class="return-back"><span class="icon-arrow_left"></span>Back</a>\n' +
                                '            <div class="profile-wrapper">\n' +
                        ...
                        $('.profile__image .contacts a:nth-child(2)').html('<span class="icon-phone"></span>'+ $('.profile__image .contacts a:nth-child(2)').text().replace(/(\d{3})(\d{3})(\d{4})/, '($1) $2-$3'));
                        readFile(".file-input")
                    },
                        ...
                        if (plan === 'pro') {
                            ...
                            $.ajax({
                                ...
                                success: function (res) {
                                    ...
                                    step8.after('<section class="register step9" style="display:none;">\n' +
                                        '    <div class="container">\n' +
                                        '        <div class="register-wrapper">\n' +
                                        '            <a href="#" class="previous-step"><span class="icon-arrow-down"></span>Previous Step</a>\n' +
                                        ...
                                        '                    <li data-tab="visa" class="active"><img src="images/mastercard.png" width="46" height="38" alt=""><img src="images/discover.png" width="47" height="30" alt=""><img src="images/AXP.png" width="40" height="30" alt=""><img src="images/visa.png" width="53" height="30" alt=""></li>\n' +
                                        '                    <li data-tab="paypal" class=""><img src="images/paypal.png" width="80" height="40" alt=""></li>\n' +
                                        '                </ul>\n' +
                                        ...
                                        '                        <input type="text" id="bilstate" placeholder="Type here" maxlength="3">\n' +
                                        '                    </div>\n' +
                                        '                    <div class="form-group small">\n' +
                                        '                        <label for="bilzip">Zip</label>\n' +
                                        '                        <input type="text" id="bilzip" placeholder="Type here" maxlength="2">\n' +
                                        '                    </div>' +
                                        '                    <h5 class="cost-price">Annual subscription cost: $<span>299.88</span></h5>\n' +
                                        '                    <h5 class="tax-price">Sales tax: $<span>' + tax + '</span></h5>\n' +
                                        '                    <h5 class="total-price">Total cost: $<span>' + total + '</span></h5>\n' +
                                        '                    <button type="submit" class="btn btn-primary">Submit payment and publish your profile</button>\n' +
                                        '                </form>\n' +
                                        '                <form id="paypal" class="pci" data-plan="pro-plus">\n' +
                                    ...
                                    success: function () {
                                        ...
                                        $.ajax({
                                            ...
                                            success: function (res) {
                                                ...
                                                step8.after('<section class="register step9-premium" style="display:none;">\n' +
                                                    '    <div class="container">\n' +
                                                    '        <div class="register-wrapper">\n' +
                                                    '            <a href="#" class="previous-step"><span class="icon-arrow-down"></span>Previous Step</a>\n' +
                                                    ...
                                                    '                <h3>Payment details</h3>\n' +
                                                    '                <ul class="payments-method">\n' +
                                                    '                    <li data-tab="visa" class="active"><img src="images/mastercard.png" width="45" height="37" alt=""><img src="images/discover.png" width="52" height="33" alt=""><img src="images/AXP.png" width="33" height="33" alt=""><img src="images/Visa.png" width="51" height="33" alt=""></li>\n' +
                                                    '                    <li data-tab="paypal" class=""><img src="images/paypal.png" width="80" height="40" alt=""></li>\n' +
                                                    '                </ul>\n' +
                                                    ...
                                                    '                    <button type="submit" class="btn btn-primary">Submit payment and publish your profile</button>\n' +
                                                    '                </form>\n' +
                                                    '                <form id="paypal" class="pci" data-plan="premium">\n' +
                                                    '                     <div id="paypal-button-container"></div>\n' +
                                                    '                </form>\n' +
                                                    '            </div>\n' +
                                                    '        </div>\n' +
    ...
    *
    */
    $(document).on('submit', '.profile .from-step8', function (e) {
        e.preventDefault();
        ...
        if($(".circle-image").attr("src")!== "images/user.png") {
            var resp = $(".circle-image").attr("src");
        }
        else{
            resp = "";
        }
                            ...
                            success: function () {
                                ...
                                $.ajax({
                                    ...
                                    step8.after('<section class="register step9-premium" style="display:none;">\n' +
                                        ...
                                        '                    <div class="form-group small">\n' +
                                        '                        <label for="cvc">CVC</label>\n' +
                                        '                        <input type="password" id="cvc" maxlength="3">\n' +
                                        '                    </div>\n' +
                                        '                    <h3>Billing address</h3>\n' +
                                        '                    <div class="form-group">\n' +
                                        '                        <label for="biladdress">Address</label>\n' +
    ...
    $(document).on('submit', '.register .pci', function (e) {
        ...
        $.ajax({
            ...
            url: apiDomain + '/Attorney/UpdateAttorneyPaymentInfo',
            beforeSend: function(){
                $("body").addClass("loading");
            },
            data: JSON.stringify({
        ...
        if(response.length !== 0) {
            $.ajax({
                ...
                success: function (data) {
                    ...
                    $("#email-success").attr('hidden', false).find(".thank-you p span").text(attorneyName);
                }
            });
        }
        else{
            if(!$('#recaptchaError-message').text()) {
                $('#recaptchaError-message').append('You must complete the verification in order to proceed.');
            }
        }
    });
    ...
    $("#refer .profile-form").on("submit", function (e) {
        ...
        if(response.length !== 0) {
            ...
            if(!$('#recaptchaError-refer').text()) {
                $('#recaptchaError-refer').append('You must complete the verification in order to proceed.');
            }
        }
    });
    ...
    if($("section").hasClass("confirm-page")) {
        ...
        if(popup === 'open'){
            $.ajax({
                type: "GET",
                url: apiDomain+'/ConfirmEmail?Code='+decodeURI(code)+'&Email='+email,
                success: function () {
    ...
    if($("section").hasClass("search-results")){
        ...
        if(ethnicity === null || ethnicity === undefined)
            ethnicity = "";
        if(experience === null || experience === undefined || experience === 'null')
            experience = "";
            ...
            success: function(res) {
                ...
                if(keywords){
                    ...
                    $.each(keywords, function (key, arr) {
                        $("#keyword").append($("<option selected></option>")
                ...
                if(count > 0) {
                    $.each(res, function (key, arr) {
                        var item;
                        var id = res[key]['id'];
                        if(res[key]['professionalInfo'] && res[key]['professionalInfo']['company']!==null) {
                            var company = res[key]['professionalInfo']['company'];
                        }
                        else{
                            company = "";
                        }
                        if(res[key]['middleName']!== undefined || res[key]['middleName']!== null){
                        ...
                        if(res[key]['profile']){
                            if(res[key]['profile']['pictureUrl']){
                                var imageP = res[key]['profile']['pictureUrl']
                            }
                            else{
                                imageP = 'images/user.png'
                            }
                            if(res[key]['profile']['headline'] && res[key]['profile']['headline']!=='undefined'){
                                var headline = res[key]['profile']['headline']
                            }
                            else{
                                headline = "";
                            }
                        ...
                        if(res[key]['professionalInfo']) {
                            $.each(res[key]['professionalInfo']['practiceAreas'], function (pkey, parr) {
                                if (res[key]['professionalInfo']['practiceAreas'][pkey] !== 'None Reported By Attorney') {
                                    tags.push('<span>' + res[key]['professionalInfo']['practiceAreas'][pkey] + '</span>');
                                }
                            });
                            tags = tags.join("");
                        }
                        ...
                        if (res[key]['contactInfo']) {
                            if (res[key]['contactInfo']['workPhoneNumber']) {
                                var phone = '<div class="column">\n' +
                                    '                 <span class="icon-phone"></span>\n' +
                                    '                 <a href="tel:' + res[key]['contactInfo']['workPhoneNumber'] + '" onclick="event.stopPropagation();">' + res[key]['contactInfo']['workPhoneNumber'] + '</a>\n' +
                                    '            </div>';
                            } else {
                                phone = "";
                            }
                        ...
                        if (type === 'Unclaimed') {
                            item = '  <div class="results-people__item" data-link="profile-unclaim.html?id=' + id + '">\n' +
                                '          <div class="item-top">\n' +
                                '                        <div class="search-checkbox">\n' +
                                '                            <input class="styled-checkbox" id="styled-checkbox-'+id+'" type="checkbox">\n' +
                                '                            <label for="styled-checkbox-'+id+'">Compare</label>\n' +
                                '                        </div>\n' +
                            ...
                            item = '<div class="results-people__item pro" data-link="profile.html?id=' + id + '">\n' +
                                '                    <div class="item-top">\n' +
                                '                        <div class="search-checkbox">\n' +
                                '                            <input class="styled-checkbox" id="styled-checkbox-'+id+'" type="checkbox">\n' +
                                '                            <label for="styled-checkbox-'+id+'">Compare</label>\n' +
                                ...
                                '                                    <a href="#" class="popup-opener" data-popup="message" data-image="' + imageP + '" data-attorney="' + id + '" data-name="' + name + '">Message</a>\n' +
                                '                                </div>\n' + phone +
                                '                                <div class="column">\n' +
                                '                                    <span class="icon-link"></span>\n' +
                                '                                    <a href="#" class="popup-opener" data-popup="refer" data-image="' + imageP + '" data-attorney="' + id + '" data-name="' + name + '">Share</a>\n' +
                                '                                </div>\n' +
                                '                            </div>\n' +
                                '                        </div>\n' +
                                '                    </div>\n' +
                            ...
                            item = '<div class="results-people__item pro-plus" data-link="profile.html?id=' + id + '">\n' +
                                '                    <div class="item-top">\n' +
                                '                        <div class="search-checkbox">\n' +
                                '                            <input class="styled-checkbox" id="styled-checkbox-'+id+'" type="checkbox">\n' +
                                '                            <label for="styled-checkbox-'+id+'">Compare</label>\n' +
                            ...
                            item = '<div class="results-people__item premium" data-link="profile-premium.html?id=' + id + '">\n' +
                                '                    <div class="item-top">\n' +
                                '                        <div class="search-checkbox">\n' +
                                '                            <input class="styled-checkbox" id="styled-checkbox-'+id+'" type="checkbox">\n' +
                                '                            <label for="styled-checkbox-'+id+'">Compare</label>\n' +
                    ...
                    if(count <= 9){
                        ...
                        var i;
                        var links = "";
                        var temp = '<a href="#" class="nav"><span class="icon-arrow-down disable prev"></span></a>\n' +
                        ...
                        for(i=1; i<=$cycleSize; i++){
                            ...
                            if(decade >= 6){
                                if(i<=6){
                                    links += '<a href="?query=' + query + '&language=' + languageUrl + '&ethnicity=' + ethnicityUrl + '&speciality=' + specialityUrl +'&location=' + location + '&practiceArea=' + practiceAreaUrl + '&experience=' + experience + '&page=' + i + '" ' + active + ' class="need-captcha">' + i + '</a>';
                                }
                                else{
                                    if(i===decade){
                                        links += '<a class="none">...</a>';
                    ...
                    var searchQuery = (query ? query : '') + (language ? ' / '+ language : '') + (practiceArea ? ' / '+ decodeURI(practiceArea) : '') + (experience ? ' / '+ experience : '') + (ethnicity ? ' / '+ decodeURI(ethnicity) : '') + (speciality ? ' / '+ decodeURI(speciality) : '') + (gender ? ' / '+ gender : '') + (location ? ' / '+location : '');
                    if(searchQuery.charAt(1) === '/'){
                        searchQuery = searchQuery.substr(3)
                    }
                    $(".search-results-inner .left-side").append('<p>'+ count +' <span class="rf">results for</span> <span class="search-name">“'+searchQuery+'”</span></p>');
                    if(count < 5){
                        $(".search-buttons-bottom").hide()
                    }
                }
                else{
                    searchQuery = (query ? query : '') + (language ? ' / '+ language : '') + (practiceArea ? ' / '+ decodeURI(practiceArea) : '') + (experience ? ' / '+ experience : '') + (ethnicity ? ' / '+ decodeURI(ethnicity) : '') + (speciality ? ' / '+ decodeURI(speciality) : '') + (gender ? ' / '+ gender : '') + (location ? ' / '+location : '');
                    if(searchQuery.charAt(1) === '/'){
                        searchQuery = searchQuery.substr(3)
                    }
                    $(".search-results-inner .left-side").append('<p><span class="rf">No results for</span> <span class="search-name">“'+searchQuery+'”</span></p>');
                    $(".results-people").prepend(' <div class="no-results">\n' +
                ...
                $.each(res, function (key, arr) {
                    ...
                    if (type === 'Unclaimed') {
                        item = '  <div class="results-people__item" data-link="profile-unclaim.html?id=' + id + '">\n' +
                            '          <div class="item-top">\n' +
                            '                        <div class="search-checkbox">\n' +
                            '                            <input class="styled-checkbox" id="styled-checkbox-'+id+'" type="checkbox" checked>\n' +
                            '                            <label for="styled-checkbox-'+id+'">Compare</label>\n' +
                            '                        </div>\n' +
                            '               <div class="item-image">\n' +
                            '                    <img src="'+imageP+'" alt="">\n' +
...
// Filter Search
    $(document).on("submit", ".results-filter-form", function (e) {
        ...
        $.ajax({
            ...
            success: function(res) {
                window.history.replaceState(null, null, "?query="+query+"&language="+languageUrl+"&location="+location+"&practiceArea="+practiceAreaUrl+"&speciality="+specialityUrl+'&experience='+experience+'&ethnicity='+ethnicityUrl+"&keywords="+keywords+"&page="+1);
                ...
                if(count > 0) {
                    ...
                    if(count <= 9){
                        ...
                        for(i=1; i<=$cycleSize; i++){
                            ...
                            if(decade >= 6){
                                if(i<=6){
                                    links += '<a href="?query=' + query + '&language=' + languageUrl + '&location=' + location + '&keywords=' + keywords + '&speciality=' + specialityUrl + '&practiceArea=' + practiceAreaUrl + '&experience=' + experience + '&ethnicity=' + ethnicityUrl + '&page=' + i + '" ' + active + ' class="need-captcha">' + i + '</a>';
                                }
                                else{
                                    if(i===decade){
                                        links += '<a class="none">...</a>';
                    ...
                    var searchQuery = (query ? query : '') + (language ? ' / '+ language : '') + (practiceArea ? ' / '+ practiceArea : '') + (experience ? ' / '+ experience : '') + (ethnicity ? ' / '+ ethnicity : '') + (speciality ? ' / '+ speciality : '') + (location ? ' / '+location : '');
                    if(searchQuery.charAt(1) === '/'){
                        searchQuery = searchQuery.substr(3)
                    }
                    $(".search-results-inner .left-side").append('<p>'+ count +' <span class="rf">results for</span> <span class="search-name">“'+searchQuery+'”</span></p>');
                    ...
                    searchQuery = (query ? query : '') + (language ? ' / '+ language : '') + (practiceArea ? ' / '+ practiceArea : '') + (experience ? ' / '+ experience : '') + (ethnicity ? ' / '+ ethnicity : '') + (speciality ? ' / '+ speciality : '') + (gender ? ' / '+ gender : '') + (location ? ' / '+location : '');
                    if(searchQuery.charAt(1) === '/'){
                        searchQuery = searchQuery.substr(3)
                    }
                    $(".search-results-inner .left-side").append('<p><span class="rf">No results for</span> <span class="search-name">“'+searchQuery+'”</span></p>');
    ...
    if($("section").hasClass("single-page-profile")){
        ...
        if(document.referrer.indexOf("search.html") > -1){
            $(".breadcrumbs li").eq(1).find("a").attr("href", "javascript:history.back()")
        }
        $.ajax({
            url: apiDomain+'/Attorney/'+id,
            type: 'GET',
            ...
            success: function(res) {
                if(res['similarAttorneys'] && res['similarAttorneys'].length > 0){
                    ...
                    var similarLayout = '<div class="related-profiles">' +
                        '<h2>Similar Lawyers</h2>' +
                        '<div class="results-people">';
                    $.each(similar, function (key, arr) {
                        var simName = '<p class="name">'+similar[key]['fullName']+'</p>';
                        if(similar[key]['professionalInfo']['company']) {
                            var company = '<p class="place">'+similar[key]['professionalInfo']['company']+'</p>';
                        }
                        else{
                            company = "";
                        }
                        ...
                        if(similar[key]['profile']){
                            if(similar[key]['profile']['pictureUrl']){
                                var image = similar[key]['profile']['pictureUrl'];
                            }
                            else{
                        ...
                        if(similar[key]['contactInfo']['workPhoneNumber']) {
                            var phone = '<div class="column">\n' +
                                '<span class="icon-phone"></span>' +
                                '<a href="tel:'+similar[key]['contactInfo']['workPhoneNumber']+'">'+similar[key]['contactInfo']['workPhoneNumber']+'</a>' +
                                '</div>';
                        }
                        else
                            phone = "";
                        ...
                        if(attorneyType === 'ProPlus'){
                            type = "pro-plus";
                            link = ''
                        }
                        if(attorneyType === 'Premium'){
                            type = "premium";
                            link = '-premium'
                        }
                        if(attorneyType === 'Undefined' || attorneyType === 'Unclaimed'){
                            type = 'unclaimed';
                            link = '-unclaimed'
                        }
                        var tags = [];
                        if(similar[key]['professionalInfo']) {
                            $.each(similar[key]['professionalInfo']['practiceAreas'], function (pkey, parr) {
                                if (similar[key]['professionalInfo']['practiceAreas'][pkey] !== 'None Reported By Attorney') {
                                    tags.push('<span>' + similar[key]['professionalInfo']['practiceAreas'][pkey] + '</span>');
                                }
                            });
                            tags = tags.join("");
                        }
                        similarLayout += '<div class="results-people__item '+type+'" data-link="profile'+link+'.html?id=' + id + '">\n' +
                            '                        <div class="item-top">\n' +
                            '                            <div class="item-image">\n' +
                            '                                <img src="'+image+'" class="circle-image" alt="">\n' +
                            '                                <span class="status">'+attorneyType+'</span>\n' +
                            '                            </div>\n' +
                            '                            <div class="item-info">\n' +
                            simName +
                            company +
                ...
                if(res['profile']){
                    if(res['profile']['pictureUrl']){
                        var imageP = res['profile']['pictureUrl'];
                    }
                    else{
                        imageP = "images/user.png";
                    }
                ...
                if(res['professionalInfo'] && res['professionalInfo']['company']!==null) {
                    var company = res['professionalInfo']['company'];
                }
                else{
                    company = "";
                ...
                var phoneSingle = res['contactInfo']['workPhoneNumber'];
                if(phoneSingle){
                    phoneSingle = '<a href="tel:' + phoneSingle + '"><span class="icon-phone"></span>' + phoneSingle + '</a>';
                }

                if(res['profile']['headline'] && res['profile']['headline']!=='undefined'){
                    var headline = '<div class="review"><p>'+res['profile']['headline']+'</p></div>'
                }
                else{
                    headline = "";
                }
                ...
                if(keywords.length > 0){
                    keywords = '<div class="info-block">\n' +
                        '                        <h3>Keywords <span class="dotted"></span></h3>\n' +
                        '                        <p class="description">'+keywords+'</p>\n' +
                        '                    </div>'
                }
                ...
                $.each(res['professionalInfo']['legalIssues'], function (pkey, parr) {
                    specialities.push('<span>' + res['professionalInfo']['legalIssues'][pkey] + '</span>');
                });
                specialities = specialities.join("");
                if(specialities.length > 0){
                    specialities = '<div class="info-block">\n' +
                ...
                if(res['biographicalInfo']['ethnicities']) {
                    $.each(res['biographicalInfo']['ethnicities'], function (pkey, parr) {
                        ethnic.push('<span>' + res['biographicalInfo']['ethnicities'][pkey] + '</span>');
                    });
                    ethnic = ethnic.join("");
                }
                ...
                if(res['contactInfo']['emailAddress']){
                    var email = ' <div class="contact-row">\n' +
                        '              <span class="icon-email"></span>\n' +
                        '              <p>'+res['contactInfo']['emailAddress']+'</p>\n' +
                        '         </div>';
                }
                else{
                    email = "";
                ...
                if(res['educationalInfo']['lawSchool']) {
                    var education = '<div class="info-block">\n' +
                        '                        <h3>Education <span class="dotted"></span></h3>\n' +
                        '                        <div class="tags">\n' +
                        '                            <span>'+res['educationalInfo']['lawSchool'] +'</span>'+
                        '                        </div>\n' +
                        '                    </div>';
                }
                else{
                ...
                if(res['profile']) {
                    if(res['profile']['about']) {
                        var about = '<h3>About <span class="dotted"></span></h3><p class="description">'+res['profile']['about']+'</p>';
                    }
                    else{
                        about = "";
                    }
                ...
                if(attorneyType === 'Unclaimed'){
                    $(".profile__info").prepend('<h2 class="name">' + name + '</h2>\n' +
                        '                    <p class="place">' + company + '</p>\n' +
                        tags +
                        specialities +
                        education +
                        ...
                        fax +
                        '                    </div>').hide().fadeIn();
                    $(".profile-wrapper .profile__image").prepend('<img src="'+imageP+'" class="circle-image" alt="">\n' +
                        '                    <span class="status">Not Active on DiversePro</span>\n' +
                        '                    <div class="contacts">\n' +
                        '                        <a href="#" class="popup-opener" data-popup="message" data-image="' + imageP + '" data-attorney="' + id + '" data-name="' + name + '"><span class="icon-email"></span>Message</a>\n' +
                        phoneSingle +
                        '                        <a href="#" class="popup-opener" data-popup="refer" data-image="' + imageP + '" data-attorney="' + id + '" data-name="' + name + '"><span class="icon-link"></span>Share</a>\n' +
                        '                    </div>\n' +
                        '                    <p class="claim-profile">Is this your profile? <a href="#" class="claim-btn" data-id="'+id+'">Claim your profile</a></p>');
                    $(".breadcrumbs .active a").text(name);
                    $(".profile-wrapper").after(similarLayout);
                }
                else if(attorneyType === 'Pro' || attorneyType === 'ProPlus'){
                    if(attorneyType === 'Pro'){
                    ...
                    $(".profile__info").prepend('<h2 class="name">' + name + '</h2>\n' +
                        ...
                        // '                            <div class="prev"><img src="images/arrow_left.svg"></div>\n' +
                        // '                            <div class="next"><img src="images/arrow_right.svg"></div>\n' +
                        // '                        </h3>\n' +
                        // '                        <div class="premium-container">\n' +
                        // '                            <div class="swiper-wrapper">\n' +
                        // '                                <div class="swiper-slide">\n' +
                        // '                                    <a href="https://www.youtube.com/watch?v=_sI_Ps7JSEk"><img src="images/photos-1.png" alt=""></a>\n' +
                        // '                                </div>\n' +
                        // '                                <div class="swiper-slide">\n' +
                        // '                                    <a href="images/Latino@2x.jpg"><img src="images/Latino@2x.jpg" alt=""></a>\n' +
                        // '                                </div>\n' +
                        // '                                <div class="swiper-slide">\n' +
                        // '                                    <a href="images/photos-1.png"><img src="images/photos-1.png" alt=""></a>\n' +
                        // '                                </div>\n' +
                        // '                                <div class="swiper-slide">\n' +
                        // '                                    <a href="images/photos-1.png"><img src="images/photos-1.png" alt=""></a>\n' +
                        // '                                </div>\n' +
...
//Share search results
    $("#share-results .profile-form").on("submit", function (e) {
        ...
        if(response.length !== 0) {
            ...
            if(!$('#recaptchaError-share').text()) {
                $('#recaptchaError-share').append('You must complete the verification in order to proceed.');
            }
        }
    });
    ...
    $("#cancel-sub .btn-primary").on("click", function (e) {
        ...
        $.ajax({
            type: "PUT",
            url: apiDomain + '/Attorney/CancelAttorneySubscription?payload='+attorneyId,
            headers: {
                'Accept': 'application/json',
                'Content-Type': 'application/json',
                'Authorization': 'Bearer ' + token
    ...
    $(document).on("change", "#request, #request2", function () {
        if($('#request').is(':checked') ) {
            ...
            $(".step1 .form-group:nth-child(2) h4").text("I affirm that I am a California resident as defined by Section 17014 of Title 18 of the California Code of Regulations.");
        }
        else if($('#request2').is(':checked')){
            $(".step1 .form-group:nth-child(2)").fadeIn();
            $(".step1 .form-group:nth-child(2) h4").text("I affirm that I am an authorized representative of a California resident as defined by Section 17014 of Title 18 of the California Code of Regulations.");
        }
    });
    ...
    if($("section").hasClass("practices")) {
        ...
        $.ajax({
            ...
            success: function (res) {
                ...
                $.each(res, function (pkey, parr) {
                    ...
                    item += '<h5><a href="/search.html?practiceArea='+res[pkey]["practiceArea"].replace(/&/g, "%26")+'&location='+city+'&page=1">'+res[pkey]["practiceArea"]+'</a></h5><ul>';
                    $.each(res[pkey]['specialities'], function (key, arr) {
                        item += '<li><a href="/search.html?speciality='+res[pkey]['specialities'][key].replace(/&/g, "%26")+'&location='+city+'&page=1">'+res[pkey]['specialities'][key]+'</a></li>';
                    });
                    item += '</ul>';
                    i++;
                });
        ...
        $.ajax({
            ...
            success: function (data) {
                $.each(data, function (key, arr) {
                    $(".practices-search").append($("<option></option>")
                        .attr("value",data[key])
